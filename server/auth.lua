...
-- For production-grade auth, swap for argon2/bcrypt via a binary native module.
...
function BB_HashPassword(password, salt)
    return sha256(salt .. ":" .. password)
end

function BB_GenerateSalt()
    return randhex(16)
end

function BB_GenerateToken()
    return randhex(32)
end
